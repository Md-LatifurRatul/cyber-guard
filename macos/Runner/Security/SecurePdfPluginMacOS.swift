...
/// Secure PDF Plugin for macOS.
///
/// Uses PDFKit (`PDFDocument`, `PDFPage`) to render PDF pages as RGBA pixel data.
/// Same architecture as iOS plugin with macOS-specific API adaptations
/// (FlutterMacOS framework, NSColor, etc.).
///
/// ## Channel: "com.cyberguard.security/pdf"
class SecurePdfPluginMacOS: NSObject, FlutterPlugin {
    ...
    private var documents: [String: MacOSPdfDocumentHandle] = [:]
    ...
    static func register(with registrar: FlutterPluginRegistrar) {
        ...
        let instance = SecurePdfPluginMacOS()
    ...
    private func handleOpen(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
        ...
        DispatchQueue.global(qos: .userInitiated).async { [weak self] in
            ...
            let handle = MacOSPdfDocumentHandle(document: pdfDocument)
...
/// Holds an open PDFDocument reference for macOS.
private class MacOSPdfDocumentHandle {
